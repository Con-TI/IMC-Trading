...
PARAMS = {
    Product.MAGNIFICENT_MACARONS:{
        "make_min_edge": 1.5,        # Increased minimum edge
        ...
        "dec_edge_discount": 0.65,   # Reduced from 0.8 to be more aggressive with edge reduction
        "step_size": 0.75            # Increased from 0.5 for faster adaptation
    }
}
