...
class Trader:
    ...
    def market_make_croissants(self, state, traderObject):
        ...
        if traderObject[Product.CROISSANTS]['last_mean'] is None:
            last_mean = traderObject[Product.CROISSANTS]['mid_price'][-1]/100 + 99/100 * self.params[Product.CROISSANTS]['last_mean']
        else:                
            last_mean = traderObject[Product.CROISSANTS]['mid_price'][-1]/100 + 99/100 * traderObject[Product.CROISSANTS]['last_mean']
        ...
        if fair_value > ask_tup[0]+1 and buy_lim > 0:
            orders.append(Order(Product.CROISSANTS,ask_tup[0],1))
        elif fair_value < bid_tup[0]-1 and sell_lim < 0:
            orders.append(Order(Product.CROISSANTS,bid_tup[0],-1))
