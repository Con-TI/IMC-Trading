...
class Trader:
    ...
    # _______________________________________________ SMILES __________________________________________________________________________________________
    ...
    def run(self, state: TradingState):
        ...
        time_to_expiry = max(0.001, 3 - (state.timestamp / 1000000))
        ...
        if "smile_history" not in traderObject:
            traderObject["smile_history"] = []
            
        traderObject["smile_history"].append({
            "timestamp": state.timestamp,
        ...
        if len(traderObject["smile_history"]) > 100:
            traderObject["smile_history"].pop(0)
        ...
        for voucher, orders in voucher_orders.items():
            if orders and voucher == Product.VOUCHER_10000:
