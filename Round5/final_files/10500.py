...
class Trader:
    def __init__(self):
        ...
        self.VOUCHER_SPREAD_FACTOR = .0001 # 7359, with 0.01, 9906 with 0.001, 10.2k with 0.0001
        self.MIN_VOUCHER_SPREAD = .1 # 5878, with 1, 5976 with .1. 
        ...
        self.VOUCHER_PARAMS = {
            Product.VOUCHER_9500: {"strike": 9500, "time_to_expiry": 5},
            Product.VOUCHER_9750: {"strike": 9750, "time_to_expiry": 5},
            Product.VOUCHER_10000: {"strike": 10000, "time_to_expiry": 5},
            Product.VOUCHER_10250: {"strike": 10250, "time_to_expiry": 5},
            Product.VOUCHER_10500: {"strike": 10500, "time_to_expiry": 5},
        }
    ...
    def run(self, state: TradingState):
        ...
        voucher_orders = {}
        for product in self.VOUCHER_PARAMS:
            if product == Product.VOUCHER_10000:
